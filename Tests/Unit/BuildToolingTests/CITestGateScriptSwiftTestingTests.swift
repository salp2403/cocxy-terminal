...
struct CITestGateScriptSwiftTestingTests {
    ...
    func performanceWorkflowEnforcesBenchmarkRegressionBaselines() throws {
        ...
        #expect((ciMetric("syntax_viewport_highlight_ms")?["baseline"] as? NSNumber)?.doubleValue == 21.0)
        #expect((ciMetric("syntax_viewport_highlight_ms")?["absolute_tolerance"] as? NSNumber)?.doubleValue == 4.0)
        ...
        #expect((ciMetric("cocxycore_surface_creation_ms")?["baseline"] as? NSNumber)?.doubleValue == 140.0)
        #expect((ciMetric("cocxycore_surface_creation_ms")?["absolute_tolerance"] as? NSNumber)?.doubleValue == 25.0)
