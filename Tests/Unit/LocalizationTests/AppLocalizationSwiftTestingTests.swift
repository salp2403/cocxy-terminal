...
struct AppLocalizationSwiftTestingTests {
    ...
    func gitHubPaneStringsLocalizeSpanish() throws {
        ...
        #expect(spanish.string("github.pane.empty.noReviewThreads", fallback: "No review threads") == "No hay threads de revisión")
        ...
        #expect(GitHubPaneViewModel.Tab.reviewThreads.localizedTitle(using: spanish) == "Threads de revisión")
