...
final class NotificationManagerImpl: NotificationManaging, UnreadCountPublishing {
    ...
    /// Local app-language resolver used for notification copy generated by
    /// this manager. Custom OSC/CLI notifications keep their provided text.
    ...
    init(
        ...
        self.localizer = localizer ?? AppLocalizer(languagePreference: config.appearance.appLanguage)
    }
    ...
    func handleStateChange(
        ...
        let agentLabel = agentName ?? localizer.string(
            "notifications.state.agentFallback",
            fallback: "Agent"
        )
        ...
        case .waitingInput:
            ...
            title = String(
                format: localizer.string(
                    "notifications.state.waitingInput.title",
            ...
            body = String(
                format: localizer.string(
                    "notifications.state.waitingInput.body",
                    fallback: "Tab \"%@\" is waiting for input."
                ),
                tabTitle
            )
        ...
        case .finished:
            ...
            title = String(
                format: localizer.string(
                    "notifications.state.finished.title",
            ...
            body = String(
                format: localizer.string(
                    "notifications.state.finished.body",
                    fallback: "Tab \"%@\" has finished."
                ),
                tabTitle
            )
        ...
        case .error:
            ...
            title = String(
                format: localizer.string(
                    "notifications.state.error.title",
            ...
            body = String(
                format: localizer.string(
                    "notifications.state.error.body",
                    fallback: "Tab \"%@\" has an error."
                ),
                tabTitle
            )
    ...
    func updateConfig(_ newConfig: CocxyConfig) {
        config = newConfig
        localizer = AppLocalizer(languagePreference: newConfig.appearance.appLanguage)
    }
